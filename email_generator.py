...
def generate_html_email_header(date_obj):
...
def generate_full_text_email(JobDataModels, date_obj):
    job_rows = '\n'.join(generate_text_rows_from_job_data_list(JobDataModels))

    return f"""
        {generate_text_email_header(date_obj)}
